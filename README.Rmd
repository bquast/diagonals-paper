...
As mentioned in the introduction, the typical use case is the mapping of a 3- or 4-dimensional array to a matrix with two edges,
...
The `size` of the the block on the diagonal here take the values `c(1,n)` with `n` being the `lenght` of the third dimension.
